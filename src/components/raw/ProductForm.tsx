...
export default class ProductForm extends React.Component<IProductFormProps, IProductFormState> {
	constructor(props: any | IProductFormProps) {
		super(props);

		if (props.initialValues) this.state = props.initialValues;
		else this.state = DEFAULT_STATE;
			...
			<section>
				...
				<form className='form-inline'>
					...
					<div className='form-group'>
						...
						<Button
							text={this.props.isCreateForm ? 'Add' : 'Save'}
